    ...
    return (
        <div className='fixed top-0 left-0 right-0 m-auto max-w-sm border border-solid border-black font-sans p-5 rounded bg-white'>
            <div className='w-full flex justify-center items-center flex-col'>
                ...
                <form onSubmit={ handleSubmit } className='flex flex-col justify-start items-center gap-5 mt-5'>
                    <input type='email' name='email' placeholder='Enter your email' className='box-border p-2 border h-10 w-full border-gray-400'/>
